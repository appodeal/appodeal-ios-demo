...
def appodeal
  pod 'Appodeal', '3.5.1'
  pod 'APDAdjustAdapter', '3.5.1.0'
  pod 'APDAmazonAdapter', '3.5.1.0'
  pod 'APDAppLovinAdapter', '3.5.1.0'
  pod 'APDAppLovinMAXAdapter', '3.5.1.0'
  pod 'APDAppsFlyerAdapter', '3.5.1.0'
  pod 'APDBidMachineAdapter', '3.5.1.0'
  pod 'APDBidonAdapter', '3.5.1.0'
  pod 'APDBigoAdsAdapter', '3.5.1.0'
  pod 'APDDTExchangeAdapter', '3.5.1.0'
  pod 'APDFacebookAdapter', '3.5.1.0'
  pod 'APDFirebaseAdapter', '3.5.1.0'
  pod 'APDGoogleAdMobAdapter', '3.5.1.0'
  pod 'APDIABAdapter', '3.5.1.0'
  pod 'APDInMobiAdapter', '3.5.1.0'
  pod 'APDIronSourceAdapter', '3.5.1.0'
  pod 'APDLevelPlayAdapter', '3.5.1.0'
  pod 'APDMetaAudienceNetworkAdapter', '3.5.1.0'
  pod 'APDMintegralAdapter', '3.5.1.0'
  pod 'APDMyTargetAdapter', '3.5.1.0'
  pod 'APDPangleAdapter', '3.5.1.0'
  pod 'APDSmaatoAdapter', '3.5.1.0'
  pod 'APDUnityAdapter', '3.5.1.0'
  pod 'APDVungleAdapter', '3.5.1.0'
  pod 'APDYandexAdapter', '3.5.1.0'
