...
def appodeal
  ...
  pod 'BidMachineAmazonAdapter', '3.5.0.0'
  pod 'BidMachineIronSourceCustomAdapter', '3.5.0.2'
  pod 'BidMachineMetaAudienceAdapter', '3.5.0.0'
  pod 'BidMachineMintegralAdapter', '3.5.0.0'
  pod 'BidMachineMyTargetAdapter', '3.5.0.0'
  pod 'BidMachinePangleAdapter', '3.5.0.0'
  pod 'BidMachineVungleAdapter', '3.5.0.0'
