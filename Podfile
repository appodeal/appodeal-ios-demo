...
def appodeal
  ...
  pod 'AppLovinMediationBidonAdapter', '0.8.2.0'
  ...
  pod 'BidonAdapterAmazon', '0.8.2.0'
  pod 'BidonAdapterBidMachine', '0.8.2.0'
  pod 'BidonAdapterBigoAds', '0.8.2.0'
  pod 'BidonAdapterChartboost', '0.8.2.0'
  pod 'BidonAdapterDTExchange', '0.8.2.0'
  pod 'BidonAdapterInMobi', '0.8.2.0'
  pod 'BidonAdapterIronSource', '0.8.2.0'
  pod 'BidonAdapterMetaAudienceNetwork', '0.8.2.0'
  pod 'BidonAdapterMintegral', '0.8.2.0'
  pod 'BidonAdapterMobileFuse', '0.8.2.0'
  pod 'BidonAdapterMyTarget', '0.8.2.0'
  pod 'BidonAdapterUnityAds', '0.8.2.0'
  pod 'BidonAdapterVungle', '0.8.2.0'
  pod 'BidonAdapterYandex', '0.8.2.0'
  pod 'ISBidonCustomAdapter', '0.8.2.0'
