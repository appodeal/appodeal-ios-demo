...
def appodeal
  pod 'Appodeal', '3.9.0'
  pod 'APDAdjustAdapter', '3.9.0.0'
  pod 'APDAmazonAdapter', '3.9.0.0'
  pod 'APDAppLovinAdapter', '3.9.0.0'
  pod 'APDAppLovinMAXAdapter', '3.9.0.0'
  pod 'APDAppsFlyerAdapter', '3.9.0.0'
  pod 'APDBidMachineAdapter', '3.9.0.0'
  pod 'APDBidonAdapter', '3.9.0.0'
  pod 'APDBigoAdsAdapter', '3.9.0.0'
  pod 'APDDTExchangeAdapter', '3.9.0.0'
  pod 'APDFacebookAdapter', '3.9.0.0'
  pod 'APDFirebaseAdapter', '3.9.0.0'
  pod 'APDGoogleAdMobAdapter', '3.9.0.0'
  pod 'APDIABAdapter', '3.9.0.0'
  pod 'APDInMobiAdapter', '3.9.0.0'
  pod 'APDIronSourceAdapter', '3.9.0.0'
  pod 'APDLevelPlayAdapter', '3.9.0.0'
  pod 'APDMetaAudienceNetworkAdapter', '3.9.0.0'
  pod 'APDMintegralAdapter', '3.9.0.0'
  pod 'APDMyTargetAdapter', '3.9.0.0'
  pod 'APDSentryAdapter', '3.9.0.0'
  pod 'APDUnityAdapter', '3.9.0.0'
  pod 'APDVungleAdapter', '3.9.0.0'
  pod 'APDYandexAdapter', '3.9.0.0'
  pod 'AppLovinMediationAmazonAdMarketplaceAdapter', '5.3.0.0'
  pod 'AppLovinMediationBidMachineAdapter', '3.4.0.0.0'
  pod 'AppLovinMediationBidonAdapter', '0.10.0.1'
  ...
  pod 'BidonAdapterAmazon', '0.10.0.0'
  pod 'BidonAdapterBidMachine', '0.10.0.0'
  pod 'BidonAdapterBigoAds', '0.10.0.0'
  pod 'BidonAdapterChartboost', '0.10.0.0'
  pod 'BidonAdapterDTExchange', '0.10.0.0'
  pod 'BidonAdapterInMobi', '0.10.0.0'
  pod 'BidonAdapterIronSource', '0.10.0.0'
  pod 'BidonAdapterMetaAudienceNetwork', '0.10.0.0'
  pod 'BidonAdapterMintegral', '0.10.0.0'
  pod 'BidonAdapterMobileFuse', '0.10.0.0'
  pod 'BidonAdapterMyTarget', '0.10.0.0'
  pod 'BidonAdapterUnityAds', '0.10.0.0'
  pod 'BidonAdapterVungle', '0.10.0.0'
  pod 'BidonAdapterYandex', '0.10.0.0'
  pod 'ISBidonCustomAdapter', '0.10.0.0'
