...
def appodeal
  pod 'Appodeal', '3.7.0'
  pod 'APDAdjustAdapter', '3.7.0.0'
  pod 'APDAmazonAdapter', '3.7.0.0'
  pod 'APDAppLovinAdapter', '3.7.0.0'
  pod 'APDAppLovinMAXAdapter', '3.7.0.0'
  pod 'APDAppsFlyerAdapter', '3.7.0.0'
  pod 'APDBidMachineAdapter', '3.7.0.0'
  pod 'APDBidonAdapter', '3.7.0.0'
  pod 'APDBigoAdsAdapter', '3.7.0.0'
  pod 'APDDTExchangeAdapter', '3.7.0.0'
  pod 'APDFacebookAdapter', '3.7.0.0'
  pod 'APDFirebaseAdapter', '3.7.0.0'
  pod 'APDGoogleAdMobAdapter', '3.7.0.0'
  pod 'APDIABAdapter', '3.7.0.0'
  pod 'APDInMobiAdapter', '3.7.0.0'
  pod 'APDIronSourceAdapter', '3.7.0.0'
  pod 'APDLevelPlayAdapter', '3.7.0.0'
  pod 'APDMetaAudienceNetworkAdapter', '3.7.0.0'
  pod 'APDMintegralAdapter', '3.7.0.0'
  pod 'APDMyTargetAdapter', '3.7.0.0'
  pod 'APDPangleAdapter', '3.7.0.0'
  pod 'APDSentryAdapter', '3.7.0.0'
  pod 'APDSmaatoAdapter', '3.7.0.0'
  pod 'APDUnityAdapter', '3.7.0.0'
  pod 'APDVungleAdapter', '3.7.0.0'
  pod 'APDYandexAdapter', '3.7.0.0'
  ...
  pod 'BidonAdapterAmazon', '0.7.23.0'
  pod 'BidonAdapterBidMachine', '0.7.23.0'
  pod 'BidonAdapterBigoAds', '0.7.23.0'
  pod 'BidonAdapterChartboost', '0.7.23.0'
  pod 'BidonAdapterDTExchange', '0.7.23.0'
  pod 'BidonAdapterInMobi', '0.7.23.0'
  pod 'BidonAdapterIronSource', '0.7.23.0'
  pod 'BidonAdapterMetaAudienceNetwork', '0.7.23.0'
  pod 'BidonAdapterMintegral', '0.7.23.0'
  pod 'BidonAdapterMobileFuse', '0.7.23.0'
  pod 'BidonAdapterMyTarget', '0.7.23.0'
  pod 'BidonAdapterUnityAds', '0.7.23.0'
  pod 'BidonAdapterVungle', '0.7.23.0'
  pod 'BidonAdapterYandex', '0.7.23.0'
  ...
  pod 'BidMachineIronSourceCustomAdapter', '3.2.1.1'
  pod 'AppLovinMediationBidonAdapter', '0.7.23.0'
end
