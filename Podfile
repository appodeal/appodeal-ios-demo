...
def appodeal
  pod 'Appodeal', '3.6.0'
  pod 'APDAdjustAdapter', '3.6.0.0'
  pod 'APDAmazonAdapter', '3.6.0.0'
  pod 'APDAppLovinAdapter', '3.6.0.0'
  pod 'APDAppLovinMAXAdapter', '3.6.0.0'
  pod 'APDAppsFlyerAdapter', '3.6.0.0'
  pod 'APDBidMachineAdapter', '3.6.0.0'
  pod 'APDBidonAdapter', '3.6.0.0'
  ...
  pod 'APDIronSourceAdapter', '3.6.0.0'
  pod 'APDLevelPlayAdapter', '3.6.0.0'
  pod 'APDMetaAudienceNetworkAdapter', '3.6.0.0'
  pod 'APDMintegralAdapter', '3.6.0.0'
  pod 'APDMyTargetAdapter', '3.6.0.0'
  pod 'APDPangleAdapter', '3.6.0.0'
  pod 'APDSentryAdapter', '3.6.0.0'
  pod 'APDSmaatoAdapter', '3.6.0.0'
  pod 'APDUnityAdapter', '3.6.0.0'
  pod 'APDVungleAdapter', '3.6.0.0'
  ...
  pod 'BidonAdapterAmazon', '0.7.19.0'
  pod 'BidonAdapterBidMachine', '0.7.19.0'
  pod 'BidonAdapterBigoAds', '0.7.19.0'
  pod 'BidonAdapterChartboost', '0.7.19.0'
  pod 'BidonAdapterDTExchange', '0.7.19.0'
  pod 'BidonAdapterInMobi', '0.7.19.0'
  pod 'BidonAdapterIronSource', '0.7.19.0'
  pod 'BidonAdapterMetaAudienceNetwork', '0.7.19.0'
  pod 'BidonAdapterMintegral', '0.7.19.0'
  pod 'BidonAdapterMobileFuse', '0.7.19.0'
  pod 'BidonAdapterMyTarget', '0.7.19.0'
  pod 'BidonAdapterUnityAds', '0.7.19.0'
  pod 'BidonAdapterVungle', '0.7.19.0'
  pod 'BidonAdapterYandex', '0.7.19.0'
